...
public class MySQLQuerying implements QueryBuilder{
    ...
    /**
     * Checks if there is already a script of the view stored via the latest record. If there is not, the
     * latest record will be null and
     * @param viewname
     * @param latest
     * @param query
     * @param definer
