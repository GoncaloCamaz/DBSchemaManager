...
/**
 * This class is responsible to decode the token that every request shall provide within Headers and then checks
 * if the request is able to proceed
 *
 * Please notice that the token specifies the user role
 */
@Component
