...
export default function PlatformsTable(props) {
                ...
                else
                {
                    let filtered = items.filter(value => {
                        return (
                            ...
                            value.url.toLowerCase().includes(target.value.toLowerCase())
                          );
                    })
                    return filtered
                }
    ...
    const handleViewCredentials = (row) => {
        props.handleViewCredentials(row)
    }
